...
static class Output
{
    ...
    public static byte[] finalize(this XElement x) => x.DescendantsAndSelf().Aggregate(Enumerable.Empty<byte>(), (sb, v) => v.emit(sb)).ToArray();
